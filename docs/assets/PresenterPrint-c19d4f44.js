import{f as d,h as _,j as p,ab as h,c as m,ac as u,l as n,ad as t,ae as s,u as o,F as f,af as g,ag as v,ah as x,n as r,ai as b,aj as y,m as j,ak as k,al as N,_ as w}from"./nav-e00a4eb8.js";import{N as P}from"./NoteViewer-fe0d1671.js";import{u as V}from"./index-f62bf7aa.js";import"./commonjsHelpers-725317a4.js";const S={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},z={class:"opacity-50"},B={class:"text-lg"},C={class:"font-bold flex gap-2"},H={class:"opacity-50"},D=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-gray-400/50 mb-8"},M=d({__name:"PresenterPrint",setup(A){_(p),h(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
